#  OrderHistory - Local Orders when ERP not available 
...
By default this behaviour is disabled and the shop will fetch the documents from ERP. To learn more about the standard implementation go to [Addon - Orderhistory.](Orderhistory_23560603.html)

The use of the local documents are enabled or disabled from the configuration (*"use\_local\_documents"* parameter )
...
Checks the exception, that was thrown by the previous listener and creates a [ResponseDocument](23560390.html) filled with local data (orders). The response will have the same structure as if it was returned from ERP, so no additional changes in the template are required.
...
1- It checks if local documents should be use (parameter *use\_local\_documents == true*)

2- Check if the requested message is *"OrderListMessage"* or *"OrderListMessage"*

3- If the previous conditions are correct then it throw an exception "UseLocalDocumentsException" that is *catch by the "Exception Event"*
...
**silver.orderhistory/src/Siso/Bundle/OrderHistoryBundle/EventListener/UseLocalDocumentsListener.php** Expand source 
...
## Order History - Generate Invoice

**Generate the invoice information: new entity and PDF[: Order process for multi-shops (with invoice in PDF)](23560832.html)**
...
2.  Generate invoice entity (special implementation to generate the invoice number)
3.  Generate invoice view
4.  Generate invoice PDF and attach it to the mail.
...
<th>Order History Detail</th>
</tr>
</thead>
<tbody>
<tr>
<td>New column with the link to the invoice page</td>
<td>Link in the header to the invoice page</td>
</tr>
<tr>
<td><div class="content-wrapper">
<img src="attachments/23560888/23563777.png" class="confluence-embedded-image" height="250" />
</td>
<td><div class="content-wrapper">
<img src="attachments/23560888/23563776.png" class="confluence-embedded-image" width="494" />
</td>
</tr>
</tbody>
</table>
...
**silver.e-shop/src/Siso/Bundle/LocalOrderManagementBundle/Controller/InvoiceController.php** Expand source 
...
![](attachments/23560888/23563238.png)

Related documentation

[Local order process (with invoice in PDF)](23560832.html)

## Attachments:

![](images/icons/bullet_blue.gif) [History detal.png](attachments/23560888/23563776.png) (image/png)  
![](images/icons/bullet_blue.gif) [History list.png](attachments/23560888/23563777.png) (image/png)  
![](images/icons/bullet_blue.gif) [invoiceShowç.png](attachments/23560888/23563238.png) (image/png)  
