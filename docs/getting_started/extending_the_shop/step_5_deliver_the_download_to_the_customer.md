...
<container xmlns="http://symfony.com/schema/dic/services"
    ...
    <parameters>
        <parameter key="ezcommerce_demo.confirmation_listener.class">DemoBundle\EventListener\DownloadOrderListener</parameter>
    </parameters>
    <services>
...
The EventListener "DownloadOrderListener" will be invoked when a customer has confirmed and payed an order.
...
class DownloadOrderListener {
                                            ...
                                            $downloadUrls = array())
    {
        ...
        $this->mailerService->sendMailWithRenderedTemplate(
            ...
            $recipient,
            $subject,
            'DemoBundle:Emails:downloads.txt.twig',
            'DemoBundle:Emails:downloads.html.twig',
            array(
                'basket' => $basket,
