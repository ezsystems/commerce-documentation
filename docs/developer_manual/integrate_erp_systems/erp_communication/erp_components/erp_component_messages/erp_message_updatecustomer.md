...
Sends customer information, like all types of addresses etc., to the ERP system.

Customer update message identifier for service

$this-\>container-\>get('silver\_erp.message\_inquiry\_service')-\>inquireMessage(UpdateCustomerFactoryListener::UPDATECUSTOMER);
...
Reusable [Party element](23560378.html)
